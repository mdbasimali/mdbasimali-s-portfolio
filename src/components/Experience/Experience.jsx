  ...
  return (
   ...
   >
    ...
    <div className='text-center mb-16'>
      <h2 className='text-4xl font-bold text-white'>EXPERINENCE</h2>
      <div className='w-32 h-1 bg-purple-500 mx-auto mt-4'>  </div>
        <p className='text-gray-400 mt-4 text-lg font-semibold'>A collection of my work experinece and the roles I have taken in 
          various organization</p>
    </div>
    {/* Experience Timeline */}
    <div className='relative '>
      {/* Create vertucal line */}
